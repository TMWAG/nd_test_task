  ...
  <Modal :open="open" @closed="closeModal">
    <form class="form">
      ...
      <div class="form__inputs">
        ...
        <PasswordInput label="Пароль" :error="passError" :pass="pass" @update:password="updatePassData" />
      </div>
      <div class="form__footer">
        <div class="form__footer-interactive">
          <TheButton @click="tryLogin"><template v-slot:text><span>Войти</span></template></TheButton>
