  ...
  <Modal :open="open" @closed="closeModal" x-register-modal>
    <form class="form">
      ...
      <div class="form__inputs">
        ...
        <PasswordInput label="Пароль" :error="passwordError" :pass="password" @update:password="updatePassword" />
        <PasswordInput label="Пароль ещё раз" :error="passwordConfirmationError" :pass="passwordConfirmation"
          @update:password="updatePasswordConfirmation" />
        <div class="form__footer">
          <div class="form__footer-interactive">
            <TheButton @click="tryRegister"><template v-slot:text><span>Зарегистрироваться</span></template> </TheButton>
